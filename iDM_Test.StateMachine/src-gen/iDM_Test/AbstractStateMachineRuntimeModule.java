...
import iDM_Test.formatting2.StateMachineFormatter;
import iDM_Test.generator.StateMachineGenerator;
import iDM_Test.parser.antlr.StateMachineAntlrTokenFileProvider;
import iDM_Test.parser.antlr.StateMachineParser;
import iDM_Test.parser.antlr.internal.InternalStateMachineLexer;
import iDM_Test.scoping.StateMachineScopeProvider;
import iDM_Test.serializer.StateMachineSemanticSequencer;
import iDM_Test.serializer.StateMachineSyntacticSequencer;
import iDM_Test.services.StateMachineGrammarAccess;
import iDM_Test.validation.StateMachineValidator;
...
public abstract class AbstractStateMachineRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "iDM_Test/StateMachine.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("iDM_Test.StateMachine");
	}
