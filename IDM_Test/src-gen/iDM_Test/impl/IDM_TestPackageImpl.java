 ...
 * @generated
 */
public class IDM_TestPackageImpl extends EPackageImpl implements IDM_TestPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see iDM_Test.IDM_TestPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private IDM_TestPackageImpl() {
		super(eNS_URI, IDM_TestFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link IDM_TestPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static IDM_TestPackage init() {
		if (isInited)
			return (IDM_TestPackage) EPackage.Registry.INSTANCE.getEPackage(IDM_TestPackage.eNS_URI);

		// Obtain or create and register package
		IDM_TestPackageImpl theIDM_TestPackage = (IDM_TestPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof IDM_TestPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
						: new IDM_TestPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theIDM_TestPackage.createPackageContents();

		// Initialize created meta-data
		theIDM_TestPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theIDM_TestPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(IDM_TestPackage.eNS_URI, theIDM_TestPackage);
		return theIDM_TestPackage;
	}
	 ...
	 * @generated
	 */
	public IDM_TestFactory getIDM_TestFactory() {
		return (IDM_TestFactory) getEFactoryInstance();
	}
